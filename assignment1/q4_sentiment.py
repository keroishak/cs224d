...
def getRegularizationValues():
    ...
    """
    values = [0.01,0.1,0.5,0.7,0.9,1]   # Assign a list of floats in the block below
...
def chooseBestModel(results):
    ...
    devAcc=results[0]["dev"]
    testAcc=results[0]["test"]
    ### YOUR CODE HERE
    for res in results[1:]:
        if devAcc<res["dev"] and testAcc<res["test"]:
            devAcc=res["dev"]
            testAcc=res["test"]
            bestResult=res
    ### END YOUR CODE
